...
.menu-item a{color: #00f; text-decoration:none; font-size:1em;}
.menu-ico img{width:2em; height:2em;}
...
<div class="foot">
	...
	<div class="menu-item">
		<a href="modules.php?app=list_all_paper">
			<div class="menu-ico">
				<img src="./skin/social/imgs/menu/<?php echo ($cur_menu=='1')?'main_btn_notebox_press.png':'main_btn_notebox_unpress.png';?>"/>
			</div>
